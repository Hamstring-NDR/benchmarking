...
class TestInit(unittest.TestCase):
    def test_successful(self):
        ...
        with patch(
            "src.test_runner.test_types.extended.SingleIntervalTest._SingleIntervalTest__get_total_message_count"
...
class TestExecuteCore(unittest.TestCase):
    ...
    def test_successful(self):
        ...
        with patch(
            ...
            "src.test_runner.test_types.extended.SingleIntervalTest._get_time_elapsed"
