...
class TestInit(unittest.TestCase):
    def test_successful_interval_based(self):
        ...
        # Act
        with patch(
            "src.test_runner.test_types.base.BenchmarkDatasetGenerator"
        ), patch("src.test_runner.test_types.base.SimpleKafkaProduceHandler"):
    ...
    def test_failed_too_low_message_count(self):
        ...
        with self.assertRaises(ValueError):
            with patch(
                ...
                "src.test_runner.test_types.base.SimpleKafkaProduceHandler"
            ):
...
class TestExecute(unittest.TestCase):
    def setUp(self):
        ...
        patcher = patch("src.test_runner.test_types.base.logger")
    ...
    def test_successful(self):
        ...
        with patch(
            "src.test_runner.test_types.base.BaseTest._setup_progress_bar"
        ) as mock_setup_progress_bar_method, patch(
            "src.test_runner.test_types.base.BaseTest._execute_core"
...
class TestSetupProgressBar(unittest.TestCase):
    def test_successful_with_intervals(self):
        ...
        self.assertNotEqual("", returned_custom_fields.get("interval").format)
    ...
    def test_successful_without_intervals(self):
        ...
        self.assertIsNotNone(returned_progress_bar)
        self.assertIsNotNone(returned_custom_fields.get("message_count"))
        self.assertEqual("", returned_custom_fields.get("interval").format)
