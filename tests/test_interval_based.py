...
class TestInit(unittest.TestCase):
    def test_successful(self):
        ...
        with patch(
            "src.test_runner.test_types.extended.IntervalBasedTest._IntervalBasedTest__normalize_intervals"
        ) as mock_normalize_intervals, patch(
            "src.test_runner.test_types.extended.IntervalBasedTest._IntervalBasedTest__validate_interval_data"
        ) as mock_validate_interval_data, patch(
            "src.test_runner.test_types.extended.IntervalBasedTest._IntervalBasedTest__get_total_message_count"
        ) as mock_get_total_message_count, patch(
            "src.test_runner.test_types.extended.BaseTest.__init__"
...
class TestExecuteCore(unittest.TestCase):
    def test_single_interval(self):
        ...
        with patch("src.test_runner.test_types.extended.BaseTest.__init__"):
            sut = IntervalBasedTest(
                name="SuT",
        ...
        with patch(
            "src.test_runner.test_types.extended.IntervalBasedTest._IntervalBasedTest__execute_single_interval"
...
class TestExecuteSingleInterval(unittest.TestCase):
    ...
    @patch(
        "src.test_runner.test_types.extended.PRODUCE_TO_TOPIC", "test_topic"
    )
    def test_successful(self):
        # Arrange
        ...
        with patch(
            ...
            "src.test_runner.test_types.extended.time.sleep"
        ) as mock_time_sleep, patch(
            "src.test_runner.test_types.extended.IntervalBasedTest._get_time_elapsed"
        ) as mock_get_time_elapsed, patch(
            "src.test_runner.test_types.extended.IntervalBasedTest._IntervalBasedTest__get_total_duration"
